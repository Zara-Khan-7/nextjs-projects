...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-[url('/bg.jpg')] bg-cover">
      {/* Timer box container */}
      <div className=" bg-yellow-100 shadow-lg rounded-lg p-8 w-full max-w-md overflow-hidden">
        {/* Title of the countdown timer */}
        <h1 className="font-serif text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200 text-center">
          Countdown Timer 🕒
        </h1>
        {/* Input and set button container */}
        <div className="font-serif flex items-center mb-6">
          <Input
            type="number"
            id="duration"
            ...
            className="flex-1 mr-4 rounded-md border-black dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 border-2"
          />
          <Button
            onClick={handleSetDuration}
            variant="outline"
            className="text-gray-800 dark:text-gray-200 border-2 border-black hover:bg-sky-200"
          >
            Set
          </Button>
        </div>
        {/* Display the formatted time left */}
        <div className="font-serif text-6xl font-bold text-gray-800 dark:text-gray-200 mb-8 text-center">
          {formatTime(timeLeft)}
        </div>
        {/* Buttons to start, pause, and reset the timer */}
        <div className="font-serif flex justify-center gap-4">
          <Button
            onClick={handleStart}
            variant="outline"
            className="text-gray-800 dark:text-gray-200 border-2 border-black hover:bg-sky-200"
